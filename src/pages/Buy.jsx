            ...
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-[#123a38] to-[#86ba8e]">
                <div className="sm:w-[40%] w-[95%] sm:mt-0 mt-5 mx-auto bg-white rounded-3xl border border-[#6EA280]">
                    <div className="flex border-b-[2.5px] border-[#103532]">
                        ...
                        <div className="pl-4">
                            <h3 className="font-inter py-3 sm:text-3xl text-base font-bold leading-none uppercase text-[#8ABD90]"> <span className="text-[#15413F]">S</span>ell <br /> <span className="text-[#15413F]">S</span>hares</h3>
                        </div>
                    </div>
                    <div className="p-8">
                            ...
                            <div className="w-full">
                                    ...
                                    <div className="sm:flex shadow-lg">
                                        ...
                                        <div className="rounded-r-md w-full border-[2px] border-[#103532] sm:py-0 py-2">
                                            <div className="flex items-center min-h-full justify-start px-3">
                                                ...
                                                <h4 className="font-inter text-[18px] leading-none font-bold text-[#204E4B]"> OPEN APP </h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="sm:ml-[25%]">
                                ...
                                <div className="w-full mt-3 ">
                                    <div className="sm:flex">
                                        ...
                                        <div className="w-full">
                                            <div className="sm:flex items-center justify-between rounded-md border-[2px] border-[#103532] sm:p-0 p-4">
                                                <div className="sm:w-[33%] text-center min-w-max">
                                                    <h4 className="font-inter text-[18px] leading-none font-bold text-[#204E4B]"> OPEN APP </h4>
                                                    <p className=" bg-transparent mt-1 font-bold text-[#528067] text-[9px]">Total : 2.5 OPEEN APP</p>
                                                </div>
                                                <div className="sm:w-[33%] text-center flex justify-center my-4">
                                                    <img src={swap} className="sm:w-[30%] w-[15%]" alt="" />
                                                </div>
                                            ...
                                            <div className="mt-10">
                                                <button className="bg-[#31685B] text-white w-full py-3 uppercase font-inter text-lg text-center rounded-md">Confirm Buy</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
