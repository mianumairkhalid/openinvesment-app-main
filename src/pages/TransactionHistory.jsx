          ...
          <div className="sm:p-8 p-2">
            <div className="w-full flex sm:flex-row flex-col items-start">
              <div className="sm:w-[20%] w-full sm:shadow-lg border-[2px] sm:border-r-0 border-[#15413F] flex justify-between p-3">
                <div className="flex justify-between items-center gap-5">
                  <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold uppercase text-[#204E4B]">
                    Oa Tesla B<span className="text-[#8FC292]">uy</span>
                  </h4>
              ...
              <div className="w-full">
                ...
                <div className="">
                  <div className="flex sm:flex-row flex-col w-full items-start">
                    <div className="flex sm:w-[70%] w-full sm:shadow-lg">
                      <div className="border-[2px] border-r-0 border-t-0 border-[#15413F] p-3">
                        <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold uppercase text-[#204E4B]">
                      ...
                      <div className="w-full border-[2px] border-t-0 border-[#15413F]">
                        <div className="flex items-center min-h-full justify-center">
                          <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold text-[#204E4B]">
                            1.2 Units (D/M/Y) (TIME STAMP)
                          </h4>
                        </div>
                      </div>
                    </div>
                    <div className="sm:w-[30%] w-full shadow-lg">
                      <div className="flex items-center border-r-[2px] border-[#15413F]">
                        <div className="border-r-[2px] sm:border-l-0 border-l-[2px] border-[#15413F] p-3">
                          <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold uppercase text-[#204E4B]">
                            Oa Tesla C<span className="text-[#8FC292]">rofit</span> &amp; L
                            <span className="text-[#8FC292]">ose</span>
                          </h4>
                        </div>
                        <div className="w-[50%]">
                  ...
                  <div className="flex sm:flex-row flex-col w-full items-start mt-2">
                    <div className="flex sm:w-[70%] w-full sm:shadow-lg">
                      <div className="border-[2px] border-r-0 border-[#15413F] p-3">
                        <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold uppercase text-[#204E4B]">
                          Oa Tesla C<span className="text-[#8FC292]">lose</span>
                        </h4>
                      </div>
                    ...
                    <div className="sm:w-[30%] w-full shadow-lg">
                      <div className="flex items-center border-t-[2px] border-r-[2px] border-[#15413F]">
                        <div className="border-r-[2px] sm:border-l-0 border-l-[2px] border-[#15413F] p-3">
                          <h4 className="font-inter sm:text-[18px] text-sm leading-none font-bold uppercase text-[#204E4B]">
                            Oa Tesla C<span className="text-[#8FC292]">rofit</span> &amp; L
                            <span className="text-[#8FC292]">ose</span>
